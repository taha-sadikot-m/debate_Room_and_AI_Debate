    ...
    case 'dashboard':
      return userRole === 'student' ? (
        <StudentDashboard 
          ...
          onPublicSpeaking={handlePublicSpeaking}
        />
      ) : (
        <TeacherDashboard />
      );
    ...
    case 'mun-mode':
      return (
        <div className="max-w-6xl mx-auto p-6 space-y-8">
          ...
          <div className="text-center">
            <Button variant="outline" onClick={handleBackToDashboard} className="border-indigo-200 text-indigo-700 hover:bg-indigo-50">
              Back to Dashboard
            </Button>
          </div>
        </div>
